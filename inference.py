This is ont of the compelete project I want to follow and here is the link 
https://github.com/liush1996/ssd_tensorflow_traffic_sign_detection.
I just start to follow the beginning code inference.py .
